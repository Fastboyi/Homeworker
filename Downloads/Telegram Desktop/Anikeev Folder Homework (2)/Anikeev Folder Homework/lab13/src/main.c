/**
 * @file main.c
 * @brief Головний файл програми для обходу структури директорій.
 */
...
/**
 * @brief Головна точка входу програми.
 * 
 ...
 * @return int Повертає 0 у випадку успіху, ненульове значення у випадку помилки.
 */
